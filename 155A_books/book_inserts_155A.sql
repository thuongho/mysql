...
Insert into a_bkorders.order_headers    values(21411,  '2012-01-12', 227105);
   Insert into a_bkorders.order_details values(21411, 1, 1128, 50, 25.00);

Insert into a_bkorders.order_headers    values(21420,  '2012-01-12', 227105);
   Insert into a_bkorders.order_details values(21420, 1, 1109, 30, 25.00);
   Insert into a_bkorders.order_details values(21420, 2, 1161, 30, 35.00);

Insert into a_bkorders.order_headers    values(21442,  '2012-01-18', 267780);
   Insert into a_bkorders.order_details values(21442, 1, 1128,  25,  12.50);
   Insert into a_bkorders.order_details values(21442, 2, 2008,  40,  34.95);
   Insert into a_bkorders.order_details values(21442, 3, 2007,  25,  35.00);
   
Insert into a_bkorders.order_headers    values(21483,   '2012-01-11',  267780);
   Insert into a_bkorders.order_details values(21483, 1, 1162,  1,  32.45);
   Insert into a_bkorders.order_details values(21483, 2, 1161,  3,  35.00);

Insert into a_bkorders.order_headers    values(21491,   '2012-01-12', 222477);
   Insert into a_bkorders.order_details values(21491, 1, 1128,  1,  49.95);
   Insert into a_bkorders.order_details values(21491, 2, 1161,  1,  35.00);
   Insert into a_bkorders.order_details values(21491, 3, 2001,  1,  39.00);

Insert into a_bkorders.order_headers    values(21552,   '2012-01-12', 227105);
   Insert into a_bkorders.order_details values(21552, 1, 1102,  2,  49.99);
...
Insert into a_bkorders.order_headers    values(51840,  '2013-07-01', 267780);
   Insert into a_bkorders.order_details values(51840, 1, 1103,  2,  12.00);

Insert into a_bkorders.order_headers    values(51841,  '2013-07-02', 272787);
...
Insert into a_bkorders.order_headers    values(51842,  '2013-07-18', 222477);
...
Insert into a_bkorders.order_headers    values(51843,  '2013-07-20', 290298);
...
Insert into a_bkorders.order_headers    values(51833,  '2013-08-08', 218709);
...
Insert into a_bkorders.order_headers    values(51850,  '2013-08-08', 299099);
   Insert into a_bkorders.order_details values(51850, 1, 1677, 1, 70.00);
   
Insert into a_bkorders.order_headers    values(51851,  '2013-08-12', 259969);
...
Insert into a_bkorders.order_headers    values(51852,  '2013-08-12', 259969);
...
Insert into a_bkorders.order_headers    values(51853,  '2013-08-25', 218709);
   Insert into a_bkorders.order_details values(51853, 4, 1161, 100, 25.25);
   
Insert into a_bkorders.order_headers    values(51854,  '2013-08-26', 239427);
   Insert into a_bkorders.order_details values(51854,  3, 1537, 15, 15.37);

Insert into a_bkorders.order_headers    values(51855,  '2013-08-26', 260368);
...
Insert into a_bkorders.order_headers    values(51856,  '2013-08-28', 272611);
...
Insert into a_bkorders.order_headers    values(51845,  '2013-09-01', 212921);
...
Insert into a_bkorders.order_headers    values(51846,  '2013-09-08', 234138);
...
Insert into a_bkorders.order_headers    values(51857,  '2013-09-08', 259969);
...
Insert into a_bkorders.order_headers    values(51858,  '2013-09-08', 259969);
...
Insert into a_bkorders.order_headers    values(51859,  '2013-09-08', 272611);
...
Insert into a_bkorders.order_headers    values(51860,  '2013-09-08', 299099);
   Insert into a_bkorders.order_details values(51860, 4, 2032, 1, 55.99);
   
   
/* Oct 2013 */   
 Insert into a_bkorders.order_headers   values(51847,  '2013-10-04', 217796);
...
Insert into a_bkorders.order_headers    values(51848,  '2013-10-05', 276381);
   Insert into a_bkorders.order_details values(51848, 1, 1544, 50,  17.76);

Insert into a_bkorders.order_headers    values(51849,  '2013-10-08', 218709);
...
Insert into a_bkorders.order_headers    values(51861,  '2013-10-01', 260368);
...
Insert into a_bkorders.order_headers    values(51862,  '2013-10-02', 272611);
   Insert into a_bkorders.order_details values(51862, 1, 1627, 4, 120.18);
     
Insert into a_bkorders.order_headers    values(51863,  '2013-10-03', 239427);
   Insert into a_bkorders.order_details values(51863, 1, 1629, 42, 19.95);
     
Insert into a_bkorders.order_headers    values(51864,  '2013-10-03', 299099);
