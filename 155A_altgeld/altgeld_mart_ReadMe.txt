Read the description of the altegeld tables in the notes for unit 03
...
Before running these scripts you need to have created the databases: a_emp, a_prd, a_oe.


You can copy the sql into a client window and run  or you can treat these as scripts and run from the command line- this is usually easier.
...
3.  run the test script. This is set up to count the rows in each table and the expected number of row is hard coded into the 
